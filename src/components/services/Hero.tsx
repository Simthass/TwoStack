...
export default function Hero() {
  ...
  const whatsappLink = "https://wa.me/94767732288?text=Hi%20Two%20Stack%2C%20I'd%20like%20to%20book%20a%2030-minute%20call%20to%20discuss%20my%20project.";

  return (
    <section className="w-full bg-[#0a0a0a] pt-[clamp(100px,15vw,160px)] pb-[clamp(48px,6vw,80px)] border-b border-white/10 px-6 lg:px-[35px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-16 items-start">
          <div>
            ...
            >
              ...
              Intelligence keeps you sharp. Most agencies build you one of
              these and leave the rest to you. Two Stack builds all three,
              wired together, as one system.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              We work with businesses that are done running on
              spreadsheets, missed WhatsApp messages and a website nobody's
              touched since launch.
            </motion.p>
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="inline-flex items-center gap-2 rounded-full bg-white text-[#0a0a0a] px-7 py-3.5 text-sm font-inter font-medium transition-all duration-300 hover:bg-[#25D366] hover:text-white hover:shadow-lg"
              >
