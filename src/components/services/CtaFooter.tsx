...
export default function CtaFooter() {
  ...
  return (
    <>
      ...
      <section
        ref={sectionRef}
        className="relative w-full overflow-hidden bg-[#ffffff] pt-40 pb-16 md:pt-56 md:pb-20 px-6 lg:px-[35px]"
      >
        {/* Semi-circle background shape */}
        <div
          className="absolute inset-0 bg-[#000000] overflow-hidden [border-radius:50%_50%_0_0/100px_100px_0_0] md:[border-radius:50%_50%_0_0/260px_260px_0_0]"
        >
        ...
        >
          ...
          >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.03 }}
              whileTap={{ scale: 0.98 }}
              className="group inline-flex items-center gap-2 bg-white text-[#000000] font-inter font-medium text-sm px-7 py-3.5 rounded-full transition-all duration-300 hover:bg-white/90 hover:shadow-lg"
            >
              <svg 
                width="18" 
                height="18" 
          ...
          >
            <div className="flex -space-x-2">
              {teamMembers.map((member) => (
                <div
                  key={member.id}
                  className="w-8 h-8 rounded-full border-2 border-[#000000] overflow-hidden relative"
                >
                  {member.image ? (
                    <Image
                      src={member.image}
