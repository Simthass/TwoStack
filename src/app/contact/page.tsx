          ...
          <div className="mx-auto grid max-w-[1300px] grid-cols-1 gap-14 lg:grid-cols-[.7fr_1.3fr] lg:gap-20">
            <Reveal>
              <div className="lg:sticky lg:top-28">
                <p className="font-inter text-[11px] uppercase tracking-[0.16em] text-black/40">
                  Direct contact
                </p>
                <div className="mt-6 border-t border-black/10">
                  ...
                  >
                    ...
                    <span className="mt-1 block font-satoshi text-xl font-medium text-black group-hover:underline">
                      {SITE.email}
                    </span>
                  </a>
                  <a
                  ...
                  <div className="border-b border-black/10 py-5">
                    ...
                    <span className="mt-1 block font-satoshi text-xl font-medium text-black">
                      {SITE.location}
                    </span>
                  </div>
                </div>
                <p className="mt-6 max-w-sm font-inter text-sm leading-6 text-black/45">
                  TwoStack works with businesses in Sri Lanka and remote clients
                  worldwide. Project communication can be handled online from
